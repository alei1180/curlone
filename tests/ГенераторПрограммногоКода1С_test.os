...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестДолжен_ПроверитьОшибкуНеУдалосьПолучитьИмяВыходногоФайлаИзURL");
	...
	СписокТестов.Добавить("ТестДолжен_ПроверитьОшибкуПроксиПротоколНеПоддерживается");	
	...
	СписокТестов.Добавить("ТестДолжен_ПроверитьПолучениеЗаголовковФайлаFTP");
