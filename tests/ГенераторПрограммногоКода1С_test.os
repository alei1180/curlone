...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестДолжен_ПроверитьПередачуВыходногоФайла");
	СписокТестов.Добавить("ТестДолжен_ПроверитьПередачуНесколькихВыходныхФайлов");
	СписокТестов.Добавить("ТестДолжен_ПроверитьКаталогСохраненияФайлов");
...
Процедура ТестДолжен_ПроверитьПередачуВыходногоФайла() Экспорт
...
Процедура ТестДолжен_ПроверитьПередачуНесколькихВыходныхФайлов() Экспорт
...
Процедура ТестДолжен_ПроверитьКаталогСохраненияФайлов() Экспорт

	КонсольнаяКоманда = "curl http://example.com -o file.html --output-dir '/some/path'";
