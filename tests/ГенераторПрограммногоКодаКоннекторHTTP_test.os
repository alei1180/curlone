...
Процедура ТестДолжен_ПроверитьПередачуТекстовыхДанныхИФайлов() Экспорт
	...
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(
	|	""param1=value1&param2=value2&param3=value3&param5=value5&param6=value6&line1
	||line2&@at@at@&param4=value4""
	|	+ ""&"" + ТекстовыеДанныеФайла_1
	|	+ ""&"" + ТекстовыеДанныеФайла_2, КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать));
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(
