...
Процедура ТестДолжен_ПроверитьБазовыеСлучаиURL() Экспорт
	...
	ТестовыеДанные.Вставить(
		...
		|ПараметрыЗапроса.Вставить(""param"", ""value"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		|ПараметрыЗапроса.Вставить(""param2"", ""value2"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		|ПараметрыЗапроса.Вставить(""param1"", ""value1"");
		|ПараметрыЗапроса.Вставить(""param2"", ""value2"");
		|ПараметрыЗапроса.Вставить(""param3"", ""value3"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param"", """");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param"", Новый Массив());
		|ПараметрыЗапроса[""param""].Добавить(""value"");
		|ПараметрыЗапроса[""param""].Добавить(""value2"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""foo"", Новый Массив());
		|ПараметрыЗапроса[""foo""].Добавить(""1"");
		|ПараметрыЗапроса[""foo""].Добавить(Неопределено);
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		"curl 'http://example.com?foo=a%20b&foo&foo=%3D'",
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""foo"", Новый Массив());
		|ПараметрыЗапроса[""foo""].Добавить(""a b"");
		|ПараметрыЗапроса[""foo""].Добавить(Неопределено);
		|ПараметрыЗапроса[""foo""].Добавить(""="");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param"", ""value with spaces"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		"ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param"", ""значение"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
	...
	ТестовыеДанные.Вставить(
		...
		|ПараметрыЗапроса.Вставить(""param"", ""value"");
		|
		|Результат = КоннекторHTTP.Get(""http://example.com#fragment"", ПараметрыЗапроса);"
	);
...
&Тест
Процедура ТестДолжен_РаскодироватьПараметрыЗапросаДляPOST() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl -X POST 'http://example.com?param=value%20with%20spaces'";

	ПрограммныйКод = "ПараметрыЗапроса = Новый Соответствие();
	|ПараметрыЗапроса.Вставить(""param"", ""value with spaces"");
	|
	|ДополнительныеПараметры = Новый Структура();
...
&Тест
Процедура ТестДолжен_СохранитьДвоеточияВПаролеПользователя() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com -u alice:p:a:ss";
	ПрограммныйКод = "Аутентификация = Новый Структура(""Пользователь, Пароль"", ""alice"", ""p:a:ss"");
	|
	|ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Аутентификация"", Аутентификация);
	|
...
&Тест
Процедура ТестДолжен_СохранитьАутентификациюВURL() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://alice:p:a:ss@example.com";
	ПрограммныйКод = "Результат = КоннекторHTTP.Get(""http://alice:p:a:ss@example.com"");";
...
&Тест
Процедура ТестДолжен_ИспользоватьАутентификациюИзОпцииВместоURL() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://urluser:urlpass@example.com -u optionuser:optionpass";
	ПрограммныйКод = "Аутентификация = Новый Структура(""Пользователь, Пароль"", ""optionuser"", ""optionpass"");
	|
	|ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Аутентификация"", Аутентификация);
	|
...
&Тест
Процедура ТестДолжен_ИспользоватьПустуюАутентификациюИзОпцииВместоURL() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://urluser:urlpass@example.com -u :";
	ПрограммныйКод = "Аутентификация = Новый Структура(""Пользователь, Пароль"", """", """");
	|
	|ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Аутентификация"", Аутентификация);
	|
...
Процедура ТестДолжен_ПроверитьПередачуТекстовыхДанныхИФайлов() Экспорт
	...
	|
	|ЧастиДанных = Новый Массив();
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(""param1=value1""
	|	+ ""&param2=value2""
	|	+ ""&param3=value3""
	|	+ ""&param5=value5""
	|	+ ""&param6=value6""
	...
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(""&"", КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать));
	|ЧастиДанных.Добавить(Новый ДвоичныеДанные(""path-to-file3""));
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(""&"", КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать));
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(""param4=value4"", КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать));
	|Данные = СоединитьДвоичныеДанные(ЧастиДанных);
	|
...
Процедура ТестДолжен_ПроверитьПередачуДанныхЧерезСоответствие() Экспорт
	...
	ТестовыеДанные.Вставить("curl http://example.com \
		|	--data 'param1=value1' \
	...
	ТестовыеДанные.Вставить(
		"curl http://example.com --data 'param=value%20with%20spaces'",
		"Данные = Новый Соответствие();
		|Данные.Вставить(""param"", ""value with spaces"");
		|
		|Результат = КоннекторHTTP.Post(""http://example.com"", Данные);"
	);

	ТестовыеДанные.Вставить(
		"curl http://example.com --data-ascii 'param=value%20with%20spaces'",
		"Данные = Новый Соответствие();
		|Данные.Вставить(""param"", ""value with spaces"");
		|
		|Результат = КоннекторHTTP.Post(""http://example.com"", Данные);"
	...
	ТестовыеДанные.Вставить("curl http://example.com \
		|	--url-query param2=value2 \
		|	--data 'param1=value1' \
		|	--data-urlencode photo@forest.jpeg",
		"ЧтениеТекста = Новый ЧтениеТекста(""forest.jpeg"");
		|ТекстовыеДанныеФайла_1 = ЧтениеТекста.Прочитать();
		|ТекстовыеДанныеФайла_1 = КодироватьСтроку(ТекстовыеДанныеФайла_1, СпособКодированияСтроки.КодировкаURL);
		|
		|Данные = Новый Соответствие();
		|Данные.Вставить(""param1"", ""value1"");
		|Данные.Вставить(""photo"", ТекстовыеДанныеФайла_1);
		|
		|ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param2"", ""value2"");
		|
	...
	ТестовыеДанные.Вставить("curl http://example.com \
		...
		|ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""param1"", ""value1"");
		|ПараметрыЗапроса.Вставить(""photo"", ТекстовыеДанныеФайла_1);
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
...
&Тест
Процедура ТестДолжен_СохранитьКодированиеТекстовогоТелаЗапроса() Экспорт

	// Подготовка
	ТестовыеДанные = Новый Соответствие();
	ПрограммныйКод = "Результат = КоннекторHTTP.Post(""http://example.com"", ""param=value%20with%20spaces"");";

	ТестовыеДанные.Вставить(
		"curl http://example.com --data-raw 'param=value%20with%20spaces'",
		ПрограммныйКод
	);
	ТестовыеДанные.Вставить(
		"curl http://example.com --data-binary 'param=value%20with%20spaces'",
		ПрограммныйКод
	);

	// Действие и Проверка
	Для Каждого ТестовыеЗначения Из ТестовыеДанные Цикл
		ВалидаторКонвертацииКоманды.Проверить(ТестовыеЗначения.Ключ, ТестовыеЗначения.Значение);
	КонецЦикла;
...
Процедура ТестДолжен_ПроверитьПередачуОдногоФайлаИзDataBinary() Экспорт
	...
	ПрограммныйКод = "Данные = Новый ДвоичныеДанные(""path-to-file1"");
	|
	|Результат = КоннекторHTTP.Post(""http://example.com"", Данные);";
...
Процедура ТестДолжен_ПроверитьПередачуДвухФайловИзDataBinary() Экспорт
	...
	ПрограммныйКод = "ЧастиДанных = Новый Массив();
	|ЧастиДанных.Добавить(Новый ДвоичныеДанные(""path-to-file1""));
	|ЧастиДанных.Добавить(ПолучитьДвоичныеДанныеИзСтроки(""&"", КодировкаТекста.UTF8, ИспользованиеByteOrderMark.НеИспользовать));
	|ЧастиДанных.Добавить(Новый ДвоичныеДанные(""path-to-file2""));
	|Данные = СоединитьДвоичныеДанные(ЧастиДанных);
	|
	|Результат = КоннекторHTTP.Post(""http://example.com"", Данные);";
...
Процедура ТестДолжен_ПроверитьПередачуТекстовыхДанныхСКодированием() Экспорт
	...
	// Подготовка
	КонсольнаяКоманда = "curl http://example.com --data-urlencode 'param=value%20with%20spaces'";
	ПрограммныйКод = "Данные = Новый Соответствие();
	|Данные.Вставить(""param"", ""value%20with%20spaces"");
	|
	|Результат = КоннекторHTTP.Post(""http://example.com"", Данные);";
...
&Тест
Процедура ТестДолжен_ПроверитьПередачуDataBinaryИзФайлаВСтрокуЗапроса() Экспорт

	// Подготовка
	// Допущение: при --get двоичный файл читается как текст, поскольку URL формируется строкой.
	КонсольнаяКоманда = "curl http://example.com --get --data-binary @path-to-file";
	ПрограммныйКод = "ЧтениеТекста = Новый ЧтениеТекста(""path-to-file"");
	|ТекстовыеДанныеФайла_1 = ЧтениеТекста.Прочитать();
	|
	|Результат = КоннекторHTTP.Get(""http://example.com?"" + ТекстовыеДанныеФайла_1);";
...
&Тест
Процедура ТестДолжен_ИспользоватьАутентификациюИзURLПрокси() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com --proxy http://alice:p:a:ss@proxy.example:1088";
	ПрограммныйКод = "Прокси = Новый ИнтернетПрокси();
	|Прокси.Установить(""http"", ""proxy.example"", 1088, ""alice"", ""p:a:ss"", Ложь);
	|
	|ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Прокси"", Прокси);
	|
...
&Тест
Процедура ТестДолжен_ПолностьюПереопределитьАутентификациюПроксиОпцией() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com \
	|	--proxy http://urluser:urlpass@proxy.example \
	|	--proxy-user explicit";
	ПрограммныйКод = "Прокси = Новый ИнтернетПрокси();
	|Прокси.Установить(""http"", ""proxy.example"", 1080, ""explicit"", , Ложь);
	|
	|ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Прокси"", Прокси);
	|
...
&Тест
Процедура ТестДолжен_ИспользоватьОтдельноЗаданноеМаксимальноеВремяОперации() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com/ --max-time 20";

	ПрограммныйКод = "ДополнительныеПараметры = Новый Структура();
	|ДополнительныеПараметры.Вставить(""Таймаут"", 20);
	|
	|Результат = КоннекторHTTP.Get(""http://example.com"", , ДополнительныеПараметры);";
...
&Тест
Процедура ТестДолжен_СохранитьПустуюСтрокуНольИЛожьВJson() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com --json '{""empty"":"""",""zero"":0,""flag"":false}'";

	ПрограммныйКод = "Данные = Новый Соответствие();
	|Данные.Вставить(""empty"", """");
	|Данные.Вставить(""zero"", 0);
	|Данные.Вставить(""flag"", Ложь);
	|
	|Заголовки = Новый Соответствие();
	|Заголовки.Вставить(""Content-Type"", ""application/json"");
	|Заголовки.Вставить(""Accept"", ""application/json"");
...
&Тест
Процедура ТестДолжен_СохранитьЗначенияВоВложенномJson() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com \
	|--json '{""nested"":{""empty"":"""",""zero"":0,""flag"":false},""items"":["""",0,false]}'";

	ПрограммныйКод = "Данные = Новый Соответствие();
	|Данные.Вставить(""nested"", Новый Соответствие());
	|Данные[""nested""].Вставить(""empty"", """");
	|Данные[""nested""].Вставить(""zero"", 0);
	|Данные[""nested""].Вставить(""flag"", Ложь);
	|Данные.Вставить(""items"", Новый Массив());
	|Данные[""items""].Добавить("""");
	|Данные[""items""].Добавить(0);
	|Данные[""items""].Добавить(Ложь);
	|
	|Заголовки = Новый Соответствие();
	|Заголовки.Вставить(""Content-Type"", ""application/json"");
	|Заголовки.Вставить(""Accept"", ""application/json"");
...
&Тест
Процедура ТестДолжен_ПреобразоватьКорневойМассивJson() Экспорт

	// Подготовка
	КонсольнаяКоманда = "curl http://example.com --json '[1,2]'";

	ПрограммныйКод = "Данные = Новый Массив();
	|Данные.Добавить(1);
	|Данные.Добавить(2);
	|
	|Заголовки = Новый Соответствие();
...
&Тест
Процедура ТестДолжен_ПроверитьПередачуМассиваВJsonИзData() Экспорт

	ТестовыеДанные = Новый Соответствие();

	ТестовыеДанные.Вставить(
		"curl -X POST 'https://markirovka.crpt.ru/api/v3/true-api/cises/info' \
		|-H 'Content-Type: application/json' \
		|-d '[""010460000000000021LLLLLLLLLLLLL""]'",
		"Данные = Новый Массив();
		|Данные.Добавить(""010460000000000021LLLLLLLLLLLLL"");
		|
		|Заголовки = Новый Соответствие();
		|Заголовки.Вставить(""Content-Type"", ""application/json"");
		|
		...
		|ДополнительныеПараметры.Вставить(""Json"", Данные);
		|
		|Результат = КоннекторHTTP.Post(""https://markirovka.crpt.ru/api/v3/true-api/cises/info"", , ДополнительныеПараметры);"
	);

	ТестовыеДанные.Вставить(
		"curl -X POST 'https://markirovka.crpt.ru/api/v3/true-api/cises/info' \
		|-H 'Content-Type: application/json' \
		|-d '[{""cis"": ""010460000000000021LLLLLLLLLLLLL""}]'",
		"Данные = Новый Массив();
		|Данные.Добавить(Новый Соответствие());
		|Данные[0].Вставить(""cis"", ""010460000000000021LLLLLLLLLLLLL"");
		|
		|Заголовки = Новый Соответствие();
		|Заголовки.Вставить(""Content-Type"", ""application/json"");
		|
...
Процедура ТестДолжен_ПроверитьПеременные() Экспорт
	...
	ТестовыеДанные.Вставить(
		...
		|
		|ПараметрыЗапроса = Новый Соответствие();
		|ПараметрыЗапроса.Вставить(""search"", QUERY1 + QUERY2);
		|
		|Результат = КоннекторHTTP.Get(""http://example.com"", ПараметрыЗапроса);"
	);
