...
&Тест
Процедура ТестДолжен_СохранитьОбратныйСлешПередОбычнымСимволомВДвойныхКавычкахBash() Экспорт

	// Подготовка
	КоманднаяСтрока = "myapp ""\d+"" ""C:\Temp\file.txt""";

	Эталон = Новый Массив;
	Команда = Новый Массив;
	Команда.Добавить("myapp");
	Команда.Добавить("\d+");
	Команда.Добавить("C:\Temp\file.txt");
	Эталон.Добавить(Команда);
...
&Тест
Процедура ТестДолжен_УдалитьОбратныйСлешПередОбратнымСлешемВДвойныхКавычкахBash() Экспорт
...
&Тест
Процедура ТестДолжен_УдалитьЭкранированныйПереносСтрокиВДвойныхКавычкахBash() Экспорт

	// Подготовка
	КоманднаяСтрока = "myapp ""line1\" + Символы.ПС + "line2""";

	Эталон = Новый Массив;
	Команда = Новый Массив;
	Команда.Добавить("myapp");
	Команда.Добавить("line1line2");
	Эталон.Добавить(Команда);
...
&Тест
Процедура ТестДолжен_РаспознатьОператорКонвейераBash() Экспорт

	// Подготовка
	КоманднаяСтрока = "curl https://example.com | jq";
...
Процедура ТестДолжен_РаспарситьПеременные() Экспорт
	...
	Команда.Добавить("myapp1");
	Команда.Добавить("-a");
	Команда.Добавить(ПрефиксХешаПеременной + ХешСтрока);
	Эталон.Добавить(Команда);
	...
	Команда.Добавить("myapp5");
	Команда.Добавить("-a");
	Команда.Добавить("Text" + ПрефиксХешаПеременной + ХешСтрока + " text");
	Эталон.Добавить(Команда);
