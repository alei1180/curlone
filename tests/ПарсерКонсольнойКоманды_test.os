...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестДолжен_РаспарситьКомандуСПробельнымиСимволамиВКонце");
	СписокТестов.Добавить("ТестДолжен_РаспарситьКомандуСДвумяСимволамиПереносаСтрокиВКонце");
