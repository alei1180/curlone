...
// Передает содержимое файла без текстовых преобразований
Перем ДвоичноеСодержимое Экспорт; // Булево
...
// Позиция соответствующей опции в исходной команде
Перем Порядок Экспорт; // Число
