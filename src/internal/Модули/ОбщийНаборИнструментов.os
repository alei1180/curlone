...
//
// Параметры:
//   Протокол - Строка - Протокол прокси-сервера для проверки
//
// Возвращаемое значение:
//   Булево
Функция ПротоколПроксиПоддерживается(Протокол) Экспорт

	ПоддерживаемыеПротоколыПрокси = Новый Массив();
	ПоддерживаемыеПротоколыПрокси.Добавить(ПротоколыCURL.HTTP());
	ПоддерживаемыеПротоколыПрокси.Добавить(ПротоколыCURL.HTTPS());
	ПоддерживаемыеПротоколыПрокси.Добавить(ПротоколыCURL.FTP());
	ПоддерживаемыеПротоколыПрокси.Добавить(ПротоколыCURL.FTPS());

	Возврат ПоддерживаемыеПротоколыПрокси.Найти(НРег(Протокол)) <> Неопределено;
...
//
// Параметры:
//   Ошибки - Массив из см. НоваяОшибка - Массив ошибок
//
// Возвращаемое значение:
//   Булево
...
Функция ЭтоHTTP(Схема) Экспорт
	Возврат Схема = ПротоколыCURL.HTTP() Или Схема = ПротоколыCURL.HTTPS();
КонецФункции
...
Функция ЭтоFTP(Схема) Экспорт
	Возврат Схема = ПротоколыCURL.FTP() Или Схема = ПротоколыCURL.FTPS();
КонецФункции
...
// Возвращает префикс хеша переменной.
//
// Возвращаемое значение:
//  Строка
Функция ПрефиксХешаПеременной() Экспорт
	Возврат "$ENV_";
КонецФункции

// Добавляет значение в соответствие, поддерживая множественные значения для одного ключа.
//
// Параметры:
//  Соответствие - Соответствие - Соответствие, в которое добавляется значение
//  Ключ - Произвольный - Ключ для добавления/обновления
//  Значение - Произвольный - Значение для добавления
Процедура ВставитьВСловарьСписков(Соответствие, Ключ, Значение) Экспорт
	...
	ИначеЕсли Не ТекущееЗначение = Неопределено Тогда

		Значения = Новый Массив();
		Значения.Добавить(ТекущееЗначение);
		Значения.Добавить(Значение);

		Соответствие[Ключ] = Значения;
