...
Перем ИспользоватьМетодJSON; // Булево
...
// Параметры:
//   Использовать - Булево
Процедура ИспользоватьМетодJSON(Использовать = Истина) Экспорт
	ИспользоватьМетодJSON = Использовать;
КонецПроцедуры
