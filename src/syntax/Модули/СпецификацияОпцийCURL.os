...
Процедура ДобавитьОписание(Состояние, ИсходныеПсевдонимы, КодТипа, ПоддерживаласьВV1)
	...
	Описание = Новый ОписаниеОпцииCURL(
		...
		ИдентификаторОбработчика(КаноническоеИмя, ПоддерживаласьВV1),
		ПоддерживаласьВV1,
		Ложь
	);
...
Функция ИдентификаторОбработчика(Имя, Поддерживается)
	...
	ВызватьИсключение СтандартныеОшибки.НарушенВнутреннийИнвариант(
		"Поддержанная опция имеет обработчик", "В каталоге отсутствует семантический обработчик"
	);
